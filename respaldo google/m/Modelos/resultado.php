<?
				...
				switch ($_POST['radio']) {
					...
					$sql="SELECT Evento.Id as Id,Evento.Ubicacion as U,Evento.Horario,Evento.Fecha_inicio as Fi,Evento.Fecha_final as Ff,Evento.Nombre as N,Evento.Negocio,Horario.Inicio as I,Horario.Cierre as D,Evento.Descripcion as Descripcion from Evento INNER JOIN Horario on Horario.Id=Evento.Horario where Nombre LIKE '%".$dato."%' and Estado='1' and curdate() BETWEEN Fecha_inicio and Fecha_final";
